...
#### Tampilan Login  
[![tampilan login](../images/sop-online/implementasi/01-tampilan-login.png)](../images/sop-online/implementasi/01-tampilan-login.png)
...
#### Tampilan Dashboard 
[![Tampilan Dashboard](../images/sop-online/implementasi/02-tampilan-dashboard.png)](../images/sop-online/implementasi/02-tampilan-dashboard.png)
...
[![Tampilan Opd](../images/sop-online/implementasi/03-tampilan-opd.png)](../images/sop-online/implementasi/03-tampilan-opd.png)

##### Tampilan Add New Opd 
[![Tampilan Add New Opd](../images/sop-online/implementasi/16-tampilan-tambah-opd.png)](../images/sop-online/implementasi/16-tampilan-tambah-opd.png)
...
[![Tampilan Add New Child](../images/sop-online/implementasi/17-tampilan-tambah-child.png)](../images/sop-online/implementasi/17-tampilan-tambah-child.png)
...
[![Tampilan Sop Online](../images/sop-online/implementasi/04-tampilan-sop-online.png)](../images/sop-online/implementasi/04-tampilan-sop-online.png)

##### Tampilan Add Sop Online 
[![Tampilan Add Sop Online](../images/sop-online/implementasi/18-tampilan-add-sop-online.png)](../images/sop-online/implementasi/18-tampilan-add-sop-online.png)

Didalam page ini terdapat menambahkan atau form input Konten Add New Sop Online yang harus diisi oleh super admin atau pengguna yang diberi hak akses oleh super admin untuk bisa menambahkan Konten Sop Online. Jika data sudah ada atau kurang lengkap maka pengguna dapat menekan tombol " Simpan " dan jika tidak ada masalah maka akan dialihkan ke page Sop Online List.

##### Tampilan View Sop Online 
[![Tampilan View Sop Online](../images/sop-online/implementasi/19-tampilan-view-sop-online.png)](../images/sop-online/implementasi/19-tampilan-view-sop-online.png)
...
[![Tampilan Workflows](../images/sop-online/implementasi/05-tampilan-workflows.png)](../images/sop-online/implementasi/05-tampilan-workflows.png)

##### Tampilan Add New Workflows 
[![Tampilan Add New Workflow](../images/sop-online/implementasi/21-tampilan-add-workflows.png)](../images/sop-online/implementasi/21-tampilan-add-workflows.png)

Didalam page ini terdapat menambahkan atau form input Konten Add New Workflow yang harus diisi oleh super admin atau pengguna yang diberi hak akses oleh super admin untuk bisa menambahkan Konten Workflow. Jika data sudah ada atau kurang lengkap maka pengguna dapat menekan tombol " Add " dan jika tidak ada masalah maka akan dialihkan ke page Workflows List.

##### Tampilan Edit Workflow 
[![Tampilan Edit Workflow](../images/sop-online/implementasi/23-tampilan-edit-workflows.png)](../images/sop-online/implementasi/23-tampilan-edit-workflows.png)
...
[![Tampilan State List](../images/sop-online/implementasi/06-tampilan-statelist.png)](../images/sop-online/implementasi/06-tampilan-statelist.png)

##### Tampilan Add new State 
[![Tampilan Add New State](../images/sop-online/implementasi/24-tampilan-add-state.png)](../images/sop-online/implementasi/24-tampilan-add-state.png)
...
##### Tampilan Edit State 
[![Tampilan Edit State](../images/sop-online/implementasi/25-tampilan-edit-state.png)](../images/sop-online/implementasi/25-tampilan-edit-state.png)

Didalam page ini terdapat edit atau update form input Konten Edit State yang harus diisi oleh super admin atau pengguna yang diberi hak akses oleh super admin untuk bisa edit atau update Konten State. Jika data sudah ada atau kurang lengkap maka pengguna dapat menekan tombol " Update " dan jika tidak ada masalah maka akan dialihkan ke page State List.
...
[![Tampilan Transition List](../images/sop-online/implementasi/07-tampilan-transition.png)](../images/sop-online/implementasi/07-tampilan-transition.png)

##### Tampilan Add New Transition 
[![Tampilan Add New Transition](../images/sop-online/implementasi/26-tampilan-add-transition.png)](../images/sop-online/implementasi/26-tampilan-add-transition.png)

Didalam page ini terdapat menambahkan atau form input Konten Add New Transition yang harus diisi oleh super admin atau pengguna yang diberi hak akses oleh super admin untuk bisa menambahkan Konten Transition. Jika data sudah ada atau kurang lengkap maka pengguna dapat menekan tombol " Add " dan jika tidak ada masalah maka akan dialihkan ke page Transition List.

##### Tampilan Edit Transition 
[![Tampilan Edit Transition](../images/sop-online/implementasi/27-tampilan-edit-transition.png)](../images/sop-online/implementasi/27-tampilan-edit-transition.png)
...
[![Tampilan Workflow Guard](../images/sop-online/implementasi/08-tampilan-workflow-guard.png)](../images/sop-online/implementasi/08-tampilan-workflow-guard.png)

##### Tampilan Add New Guard 
[![Tampilan Add New Guard](../images/sop-online/implementasi/28-tampilan-add-guard.png)](../images/sop-online/implementasi/28-tampilan-add-guard.png)
...
##### Tampilan Edit Guard 
[![Tampilan Edit Guard](../images/sop-online/implementasi/29-tampilan-edit-guard.png)](../images/sop-online/implementasi/29-tampilan-edit-guard.png)


Didalam page ini terdapat edit atau update form input Konten Edit Workflow Guard yang harus diisi oleh super admin atau pengguna yang diberi hak akses oleh super admin untuk bisa edit atau update Konten Transition. Jika data sudah lengkap atau kurang lengkap maka pengguna dapat menekan tombol " Update " dan jika tidak ada masalah maka akan dialihkan ke page Guard List.
...
[![Tampilan Workflow Attachment](../images/sop-online/implementasi/09-tampilan-workflow-attachment.png)](../images/sop-online/implementasi/09-tampilan-workflow-attachment.png)

##### Tampilan Add New Attachment 
[![Tampilan Add New Attachment](../images/sop-online/implementasi/30-tampilan-add-attachment.png)](../images/sop-online/implementasi/30-tampilan-add-attachment.png)

Didalam page ini terdapat menambahkan atau form input Konten Add New Attachment yang harus diisi oleh super admin atau pengguna yang diberi hak akses oleh super admin untuk bisa menambahkan Konten Workflow Attachment. Jika data sudah ada atau kurang lengkap maka pengguna dapat menekan tombol " Add " dan jika tidak ada masalah maka akan dialihkan ke page Attachment List.

##### Tampilan Edit Attachment 
[![Tampilan Edit Attachment](../images/sop-online/implementasi/31-tampilan-edit-attachment.png)](../images/sop-online/implementasi/31-tampilan-edit-attachment.png)
...
[![Tampilan Workflow Content](../images/sop-online/implementasi/10-tampilan-workflow-content.png)](../images/sop-online/implementasi/10-tampilan-workflow-content.png)


##### Tampilan Add New Content 
[![Tampilan Add New Content](../images/sop-online/implementasi/32-tampilan-add-content.png)](../images/sop-online/implementasi/32-tampilan-add-content.png)
...
[![Tampilan Workflow History](../images/sop-online/implementasi/11-tampilan-workflow-history.png)](../images/sop-online/implementasi/11-tampilan-workflow-history.png)
...
[![Tampilan User](../images/sop-online/implementasi/12-tampilan-user.png)](../images/sop-online/implementasi/12-tampilan-user.png.png)

##### Tampilan Add User 
[![Tampilan Add User](../images/sop-online/implementasi/34-tampilan-add-user.png)](../images/sop-online/implementasi/34-tampilan-add-user.png)
...
##### Tampilan Edit User
[![Tampilan Edit User](../images/sop-online/implementasi/35-tampilan-edit-user.png)](../images/sop-online/implementasi/35-tampilan-edit-user.png)

Didalam page ini terdapat edit atau update form input Konten Edit User yang harus diisi oleh super admin atau pengguna yang diberi hak akses oleh super admin untuk bisa edit atau update Konten User. Jika data sudah lengkap atau kurang lengkap maka pengguna dapat menekan tombol " Update " dan jika tidak ada masalah maka akan dialihkan ke page User List.
...
[![Tampilan Permission](../images/sop-online/implementasi/13-tampilan-permission.png)](../images/sop-online/implementasi/13-tampilan-permission.png)


##### Tampilan Add New Permission 
[![Tampilan Add New Permission](../images/sop-online/implementasi/36-tampilan-add-permission.png)](../images/sop-online/implementasi/36-tampilan-add-permission.png)

Didalam page ini terdapat menambahkan atau form input Konten Add New Permission yang harus diisi oleh super admin atau pengguna yang diberi hak akses oleh super admin untuk bisa menambahkan Konten Permission. Jika data sudah ada atau kurang lengkap maka pengguna dapat menekan tombol " Add " dan jika tidak ada masalah maka akan dialihkan ke page Permission List.

##### Tampilan View Permission 
[![Tampilan View Permission](../images/sop-online/implementasi/37-tampilan-view-permission.png)](../images/sop-online/implementasi/37-tampilan-view-permission.png)
...
[![Tampilan Edit Permission](../images/sop-online/implementasi/38-tampilan-edit-permission.png)](../images/sop-online/implementasi/38-tampilan-edit-permission.png)

Didalam page ini terdapat edit atau update form input Konten Edit Permission yang harus diisi oleh super admin atau pengguna yang diberi hak akses oleh super admin untuk bisa edit atau update Konten Permission. Jika data sudah lengkap atau kurang lengkap maka pengguna dapat menekan tombol " Update " dan jika tidak ada masalah maka akan dialihkan ke page Permission List.
...
[![Tampilan Role](../images/sop-online/implementasi/14-tampilan-role.png)](../images/sop-online/implementasi/14-tampilan-role.png)

##### Tampilan New Role 
[![Tampilan New Role](../images/sop-online/implementasi/39-tampilan-new-role.png)](../images/sop-online/implementasi/39-tampilan-new-role.png)

Didalam page ini terdapat menambahkan atau form input Konten Add New Role yang harus diisi oleh super admin atau pengguna yang diberi hak akses oleh super admin untuk bisa menambahkan Konten Role. Jika data sudah ada atau kurang lengkap maka pengguna dapat menekan tombol " Add " dan jika tidak ada masalah maka akan dialihkan ke page Role List.

##### Tampilan View Role 
[![Tampilan View Role](../images/sop-online/implementasi/40-tampilan-view-role.png)](../images/sop-online/implementasi/40-tampilan-view-role.png)
...
##### Tampilan Edit Role 
[![Tampilan Edit Role](../images/sop-online/implementasi/41-tampilan-edit-role.png)](../images/sop-online/implementasi/41-tampilan-edit-role.png)

Didalam page ini terdapat edit atau update form input Konten Edit Role yang harus diisi oleh super admin atau pengguna yang diberi hak akses oleh super admin untuk bisa edit atau update Konten Role. Jika data sudah lengkap atau kurang lengkap maka pengguna dapat menekan tombol " Update " dan jika tidak ada masalah maka akan dialihkan ke page Role List.
...
[![Tampilan Laporan](../images/sop-online/implementasi/15-tampilan-laporan.png)](../images/sop-online/implementasi/15-tampilan-laporan.png)
